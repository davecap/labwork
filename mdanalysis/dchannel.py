# CcO D-channel analysis
#
# center of mass of PEPA 286
# center of mass of PEPA 132
# center of mass of PEPA 139
# save the distance(COM286, ION)
# find all ions and oxygen atoms inside the D-channel
# project their coordinates on to the axis defined by the COM286 and COM132
# bin the data and store the bin counts
#
...
import logging
logger = logging.getLogger('dchannel')
